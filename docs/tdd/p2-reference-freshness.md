...
当前状态：P2.1b 已完成并经 PR #5 合入 `main`；merge revision
`e90cacb9ace47292ac0869d09b3a64f7c7fe2144`，CI canonical release gate 通过。最终候选
为827/827通过。第一次完整快速门禁793/798和冻结前
...
- [x] 冻结复审确认无 P0/P1。
- [x] PR #5 CI 通过并合入 `main`；merge revision
