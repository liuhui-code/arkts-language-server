...
| --- | --- | --- | --- | --- |
| R-01 | Must | Phase-level semantic tracing | In progress: batch timeline and Worker prepare/program/query timings GREEN | Next: queue/anchor/index correlation and compiler-internal split; default-off real-LSP timeline, no semantic change |
