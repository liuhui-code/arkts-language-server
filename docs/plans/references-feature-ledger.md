...
| R-02 | Must | Fixed manifests and exact oracle | In progress: pinned Settings checkout declares compile 23 and uses selected API 24. Its same-SDK 248-Location oracle and manifest passed three independent cold processes per legacy/batched/indexed strategy plus six 11-request indexed series across pre/post F6b builds; API 23 is not a blocker for this performance track | [Settings baseline](../reports/2026-09-21-settings-api24-benchmark.md) and [F6b runs](../reports/2026-09-21-settings-api24-diagnostic-cache.md): add second real symbol and no-declaration oracle, investigate 18 diagnostic errors, grow randomized sample; retain separate matched-SDK/cross-version gate |
