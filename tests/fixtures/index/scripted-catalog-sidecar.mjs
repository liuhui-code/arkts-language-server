  ...
  switch (request.method) {
    ...
    case "references/candidates": {
      ...
      respond(request.id, {
        ...
        bindings: supported && sdkTerminal ? [
        ...
        ] : [])] : supported && !directImportAnchor && !semanticUnits ? [
          {
            kind: "reexport",
          ...
          {
            kind: "import",
            uri: pathToFileURL(path.join(workspaceRoot, "Query.ets")).href,
          ...
          {
            kind: "import",
            uri: pathToFileURL(path.join(workspaceRoot, "Use.ets")).href,
            importedName: "PublicThing",
            localName: "Alias",
            sourceSpecifier: "./Barrel",
            sourceResolution: "unique",
