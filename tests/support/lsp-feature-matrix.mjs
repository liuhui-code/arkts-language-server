...
export const CURRENT_LSP_FEATURE_MATRIX = Object.freeze({
  ...
  features: Object.freeze([
    ...
    enabledFeature({
      ...
      artifactGap: "Installed artifacts do not run a completion transcript yet.",
    }),
    enabledFeature({
      id: "definition",
      ...
      artifactGap: "Installed artifacts do not run a definition transcript yet.",
      knownGaps: ["Definition ranges are not yet proven to select the complete target name."],
    }),
    enabledFeature({
      id: "hover",
    ...
    enabledFeature({
      ...
      artifactGap: "Installed artifacts do not verify push diagnostics yet.",
      knownGaps: ["Published diagnostics do not expose a stable code yet."],
    }),
    plannedFeature(
      "completion-resolve",
      "completionProvider.resolveProvider",
      "Completion resolve and auto-import are not enabled.",
    ),
    plannedFeature(
      "references",
      "referencesProvider",
